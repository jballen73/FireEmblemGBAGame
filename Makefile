...
PROGNAME = FireEmblemProofOfConcept
...
OFILES = gba.o font.o logic.o graphics.o main.o images/sprites.o images/sprites2.o graphics2.o images/BattleBackground.o items.o images/MapBackground.o
